...
var CardButtonsComponent = /** @class */ (function () {
    //R
    function CardButtonsComponent(GListService, formatService, snackBar, helper) {
    ...
    CardButtonsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__g_list_service__["a" /* GListService */], __WEBPACK_IMPORTED_MODULE_3__frormat_service__["a" /* FormatService */],
            __WEBPACK_IMPORTED_MODULE_4__angular_material__["l" /* MatSnackBar */], __WEBPACK_IMPORTED_MODULE_2__helpers_service__["a" /* HelpersService */]])
...
var GAddComponent = /** @class */ (function () {
    ...
    GAddComponent.prototype.add = function (g) {
        ...
        this.GListService.isGroceryNameExsits(g.name).subscribe(function (res) {
            ...
            if (!res) {
                g.timeout = _this.timeoutDay * 3600 * 24;
                var grocery = _this.formatService.Toadd(g, g.name, g.basic, g.timeout, _this.lastmoreInformations);
                _this.GListService.UpdateStatus(grocery, "add");
                _this.GList.push(grocery);
            }
        });
    };
    //Needed Logic
...
var GListService = /** @class */ (function () {
    ...
    GListService.prototype.getGroceryDetails = function (id) {
        return this.http.get(BASRURL + "/" + id);
    };
    //===== Updates
    GListService.prototype.UpdateStatus = function (grocery, req) {
        ...
        this.http.post(BASRURL + "/request/" + req, grocery).subscribe(function (response) {
            ...
            console.log(response);
            console.log("<=======");
            _this.snackBar.open("" + response, "X", { duration: 2000, });
        });
    };
    //===== Services
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__g_list_service__ = __webpack_require__("./src/app/g-list.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
...
var GListComponent = /** @class */ (function () {
    function GListComponent(GListService, http) {
        this.GListService = GListService;
        this.http = http;
        this.NeededOnly = this.GListService.GetNeededOnly();
    }
    ...
    GListComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__g_list_service__["a" /* GListService */], __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]])
    ], GListComponent);
...
module.exports = "<button *ngIf=\"!bought\" (click)='Bought(Item);boughtClicked=!boughtClicked' mat-raised-button class=\"bought\">\r\n  Bought</button>\r\n<button *ngIf=\"bought\" (click)='Needed(Item);' mat-raised-button color=\"primary\" class=\"needed\">\r\n  Needed</button>"
